...
#SBATCH --job-name="UNet_bottle_bowl/bottle"
...
SCRIPT_NAME="UNet_bottle_bowl_bottle"
...
SCRIPT_ARGS="--model ORIG_STG1 --experiment ${SCRIPT_NAME} \
	...
	--saveEpoch 100 --category bottle\
	--gpu 1 --path /data/csc4801/KedzioraLab/TrainingData/ModelNet12/bottle_bowl/bottle\
	--architecture UNet"
...
SCRIPT_ARGS2="--model ORIG_STG2 --experiment ${SCRIPT_NAME} \
	...
	--optim adam --trueWD 1e-4 --lr 3e-4 --category bottle\
	--gpu 1 --path /data/csc4801/KedzioraLab/TrainingData/ModelNet12/bottle_bowl/bottle \
	--architecture UNet"
...
SCRIPT_ARGS3="--model ORIG_STG2 --experiment ${SCRIPT_NAME} \
	...
	--chunkSize 32 --batchSize 32 --category bottle\
	--gpu 1 --path /data/csc4801/KedzioraLab/TrainingData/ModelNet12/bottle_bowl/bottle \
	--architecture UNet"
