...
def check_valid_thingiverse(base_directory: str):
    df = pd.DataFrame()
    try:
        stl_file_pattern = os.path.join(base_directory, '*.stl')
        ...
        df.to_csv('chair_stls.csv', index = False, encoding='utf-8')
...
if __name__ == '__main__':
    check_valid_thingiverse('/data/csc4801/KedzioraLab/generated/chair')