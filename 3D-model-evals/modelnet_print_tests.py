...
def check_valid_modelnet(base_directory: str):
    df = pd.DataFrame()
    try:
        for category in os.listdir(base_directory):
            ...
            if os.path.isdir(category_path):
                stl_file_pattern = os.path.join(category_path, 'train', 'stl', '*.stl')
        ...
        df.to_csv('modelnet_stls.csv', index = False, encoding='utf-8')
...
if __name__ == '__main__':
    check_valid_modelnet('/data/csc4801/KedzioraLab/ModelNet40/')