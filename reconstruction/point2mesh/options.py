...
MANIFOLD_DIR = r'/data/csc4801/KedzioraLab/envs/Manifold/build'  # path to manifold software (https://github.com/hjwdzh/Manifold)
...
class Options:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--samples', type=int, metavar='N', default=12500, help='number of points to sample reconstruction with')
        parser.add_argument('--begin-samples', type=int, metavar='N', default=7500, help='num pts to start with')
        parser.add_argument('--iterations', type=int, metavar='N', default=1000, help='number of iterations to do')
        parser.add_argument('--upsamp', type=int, metavar='N', default=500, help='upsample each {upsamp} iteration')
        parser.add_argument('--max-faces', type=int, metavar='N', default=5000, help='maximum number of faces to upsample to')
        #parser.add_argument('--samples', type=int, metavar='N', default=25000, help='number of points to sample reconstruction with')
        ...
        #parser.add_argument('--max-faces', type=int, metavar='N', default=10000, help='maximum number of faces to upsample to')

        parser.add_argument('--faces-to-part', nargs='+', default=[8000, 16000, 20000], type=int, help='after how many faces to split')
        ...
        parser.add_argument('--manifold-res', default=50000, type=int, help='resolution for manifold upsampling')
