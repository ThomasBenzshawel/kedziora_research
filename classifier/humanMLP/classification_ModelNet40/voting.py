...
def parse_args():
    ...
    parser.add_argument('--partition', type=str, choices=['test', 'thingiverse'], help='Partition of data to vote on')
...
def main():
    ...
    test_loader = DataLoader(ModelNet40(partition=args.partition, num_points=args.num_points), num_workers=4, batch_size=args.batch_size // 2, shuffle=False, drop_last=False)
    # Model
