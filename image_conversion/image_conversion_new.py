...
def main():
    ...
    eight_point = np.array([quaternionToRotMatrix(camPosToQuaternion(cam_pos)) for cam_pos in cam_pos_all], dtype=np.float64)

    base_directory = '/data/csc4801/KedzioraLab/ModelNet12/'
    save_directory = '/data/csc4801/KedzioraLab/TrainingData/ModelNet12/'
        ...
        if os.path.isdir(category_path):
            for train_test in os.listdir(category_path):
                ...
                for stl_file in glob.glob(stl_files_pattern):
                    args.append([category_name, stl_file, dpth_dir, dpth_fixed_dir, img_dir, gt_dir, obj_dir, eight_point])
