...
{DEFAULT_IMAGE_TOKEN} Front view
{DEFAULT_IMAGE_TOKEN} Back view  
{DEFAULT_IMAGE_TOKEN} Right view
{DEFAULT_IMAGE_TOKEN} Left view
{DEFAULT_IMAGE_TOKEN} Top view
{DEFAULT_IMAGE_TOKEN} Bottom view
...
Long Description: [Detailed description focusing on geometric shapes, component relationships,
 and structural details for modeling the object out of legos. Focus on basic geometric shapes and forms, component relationships and structure,
 high-level visual details and patterns, distinctive features and their purpose, proportions of important pieces compared to the whole object,
 and construction/connections between parts. NEVER EVER mention specific measurements, detailed texture information, 
 material properties like weight/density/glossiness, references to environment/context, and lighting/shadows. Those are only there to help you
 understand the object better, but they are not relevant for your output response.]
...
1 means you are not confident at all, and 10 means you are very confident that your description is high enough
 quality to model the object blindfolded.]
...
- Focus on shapes, forms, and spatial relationships rather than textures or materials"""
